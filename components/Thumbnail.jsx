...
export default function Thumbnail({ item }) {
  return (
    <div className="flex relative w-32 sm:w-full items-center transition-all duration-200 ease-out scale-100 hover:scale-125 z-10 hover:z-20 hover:shadow-lg hover:shadow-zinc-900">
      <Image
        key={item.id}
